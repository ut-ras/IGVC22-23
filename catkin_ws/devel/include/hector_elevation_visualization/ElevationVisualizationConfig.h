...
namespace hector_elevation_visualization
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(ElevationVisualizationConfig &config, const ElevationVisualizationConfig &max, const ElevationVisualizationConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const ElevationVisualizationConfig &config1, const ElevationVisualizationConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, ElevationVisualizationConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const ElevationVisualizationConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, ElevationVisualizationConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const ElevationVisualizationConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const ElevationVisualizationConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, ElevationVisualizationConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
